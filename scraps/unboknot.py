...
class Book_analyzer(object):
    ...
    def __init__(self, bookfile):
        ...
        for line in self.f:
            ...
            # according to question 6, self.words is our starting point
...
print('the third most frequently used word in Moby Dick is ', (analyze.get_nth(3)))
...
for p, q in grades.items():
    string += '\n' + p  + ': '
    for subkey, subval in q.items():
        string += subkey + "'s " + str (len(subval)) + ', ' 
        string = string.strip(" , ")
