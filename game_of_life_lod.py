...
class golBoard(object):
    ...
    def liveOrDie(self,r,c):
        ...
        neighbors.append(self.currentGen[r][(c+1) % self.width])                       # right side except corners
        neighbors.append(self.currentGen[r][(c-1) % self.width])                       # left side except corners 
        neighbors.append(self.currentGen[(r+1) % self.height][(c+1) % self.width])     # lower left corner
